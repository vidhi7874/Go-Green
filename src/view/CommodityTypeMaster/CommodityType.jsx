...
const CommodityType = () => {
  ...
  const viewForm = (info) => {
    ...
    const typeId = info.row.original.id;

    console.log("Navigating to role id:", typeId);

    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_COMMODITY_COMMODITY_TYPE_EDIT}/${typeId}`, {
      state: {
  ...
  const addForm = () => {
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_COMMODITY_COMMODITY_TYPE_ADD}`);
  };
  ...
  const editForm = (info) => {
    ...
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_COMMODITY_COMMODITY_TYPE_EDIT}/${editedFormId}`, {
