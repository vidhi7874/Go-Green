...
const WarehouseTypeMaster = () => {
  ...
  const viewForm = (info) => {
    ...
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_WAREHOUSE_WAREHOUSE_TYPE_EDIT}/${typeId}`, {
      state: {
  ...
  const addForm = () => {
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_WAREHOUSE_WAREHOUSE_TYPE_ADD}`);
  };
  ...
  const editForm = (info) => {
    ...
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_WAREHOUSE_WAREHOUSE_TYPE_EDIT}/${editedFormId}`, {
