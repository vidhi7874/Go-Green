...
const HsnMaster = () => {
  ...
  const viewForm = (info) => {
    ...
    const hsnId = info.row.original.id;

    console.log("Navigating to role id:", hsnId);

    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_COMMODITY_HSN_EDIT}/${hsnId}`, {
      state: {
  ...
  const editForm = (info) => {
    ...
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_COMMODITY_HSN_EDIT}/${editedFormId}`, {
  ...
  const addForm = () => {
    navigate(`${ROUTE_PATH.ALL_MASTER_MANAGE_COMMODITY_HSN_ADD}`);
  };
