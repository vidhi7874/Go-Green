...
const OtherDetails = React.memo(
  ({ mainFormsMethod, other_details_form_schema, saveFunction }) => {
    ...
    // ! commmented the un  used rtk hook ...
    // const [
    //   AddInspectionMaster,
    //   //  { isLoading: addInspectionMasterApiIsLoading }
    // ] = useAddInspectionMasterMutation();

    // ! commented the unused function saveAasdDraft..
              ...
              >
                <Box>
                  <RadioGroup
                    ...
                    isDisabled={getValues("form_edit")}
                    value={
                      getValues(other_details_form_schema.riots_prone) ||
                      "false"
                    }
              ...
              >
                <Box>
                  <RadioGroup
                    ...
                    isDisabled={getValues("form_edit")}
                    value={
                      getValues(other_details_form_schema.flood_prone) ||
                      "false"
                    }
          ...
          >
            ...
            <GridItem colSpan={{ base: 1 }}>
              <FormControl
                style={{ w: commonWidth.w }}
                isInvalid={
                  errors?.[other_details_form_schema.fire_extinguishers]
                    ?.message
                }
              >
                <Box>
