...
const TransferMaster = () => {
  ...
  const addForm = () => {
    ...
    navigation(
      `${ROUTE_PATH.ALL_MASTER_MANAGE_SECURITY_GUARD_SECIRITY_TRANSFER}`
    );
  };
  ...
  const editForm = (info) => {
    ...
    console.log("Navigating to role id:", editedFormId);

    navigation(
      `${ROUTE_PATH.ALL_MASTER_MANAGE_SECURITY_GUARD_SECIRITY_TRANSFER_EDIT}/${editedFormId}`,
      {
