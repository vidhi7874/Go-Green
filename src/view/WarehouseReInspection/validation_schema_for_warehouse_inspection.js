...
const form_schema = Yup.object().shape({
  ...
  [schema_obj.second_accordion.mandi_license_number]: Yup.string(),
  [schema_obj.second_accordion.mandi_license_start_date]: Yup.string().trim(),
  [schema_obj.second_accordion.mandi_license_end_date]: Yup.string()
    .trim()
    .test(
      "is-greater-than-start",
      "End date must be after start date",
      function (value) {
        const { mandi_license_start_date } = this.parent;

        // If agreement_start_date is not provided, consider the validation as success
        if (!mandi_license_start_date || !value) {
          return true;
        }

        // Compare the dates
        const startDate = new Date(mandi_license_start_date);
        const endDate = new Date(value);
  ...
  [schema_obj.fourth_accordion.pre_funded_flag]: Yup.number().when(
    "commodity_inward_type",
    {
      is: (value) => value === "PS",
  ...
  [schema_obj.fourth_accordion.pre_funded_bank]: Yup.number().when(
    "pre_funded_flag",
    {
      is: (value) => value === "true",
      then: () => Yup.number().required(""),
  ...
  [schema_obj.fourth_accordion.pre_funded_branch]: Yup.number().when(
    "pre_funded_flag",
    {
      is: (value) => value === "true",
      then: () => Yup.number().required(""),
  ...
  [schema_obj.fifth_accordion.weighbridge_type]: Yup.number().when(
    "weightment_facility",
    {
      is: (value) => value === "true",
      then: () => Yup.number().required(""),
  ...
  [schema_obj.other_accordion?.factory_premises]: Yup.string().required(""),
  [schema_obj.other_accordion?.port_premises]: Yup.string().required(""),
  [schema_obj.other_accordion?.wh_clean]: Yup.string().required(""),
  [schema_obj.other_accordion?.rodent_in_wh]: Yup.string().required(""),
  [schema_obj.other_accordion?.infestation_in_wh]: Yup.string().required(""),
  [schema_obj.other_accordion?.fire_fight_available]: Yup.string().required(""),
  [schema_obj.other_accordion?.fire_extinguisher_count]:
    Yup.number().required(""),
  [schema_obj.other_accordion?.expiry_date_equipment]:
    Yup.string().required(""),
  [schema_obj.other_accordion?.police_station_distance]:
    Yup.number().required(""),
  [schema_obj.other_accordion?.police_address]: Yup.string().required(""),
  [schema_obj.other_accordion?.police_contact_no]: Yup.string().required(""),
  [schema_obj.other_accordion?.fire_station_distance]:
    Yup.number().required(""),
  [schema_obj.other_accordion?.fire_address]: Yup.string().required(""),
  [schema_obj.other_accordion?.fire_contact_no]: Yup.string().required(""),
  [schema_obj.other_accordion?.godown_structure]: Yup.string().required(""),
  [schema_obj.other_accordion?.kaccha_risk]: Yup.string().required(""),
