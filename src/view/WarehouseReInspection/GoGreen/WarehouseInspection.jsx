...
const ReInspectionStandard = React.memo(() => {
  ...
  console.log(
    "reInspectionFetchedData: data in the state >>>",
    reInspectionFetchedData?.hiring_proposal?.proposal_number
  );
  ...
  const [getReInspectionAllData, { isLoading: reInspectionAllDataLoading }] =
    useGetReInspectionAllDataMutation();
  ...
  async function fetchReInspectionData() {
    ...
    console.log("response ankti--> ", response);

    // setting up the values from the fetch api
    console.log("kunal >>", response?.data?.distance_between_walls_and_stock);
    let obj = {
      [schema_obj.first_accordion.hiring_proposal]:
        response?.data?.hiring_proposal?.proposal_number,
      [schema_obj.first_accordion.warehouse_type]:
        response?.data?.warehouse_type?.id,
      [schema_obj.first_accordion.warehouse_sub_type]:
        response?.data?.warehouse_sub_type?.id,
      [schema_obj.first_accordion.warehouse_unit_type]:
        response?.data?.warehouse_unit_type?.id,
      [schema_obj.first_accordion.warehouse_name]:
        response?.data?.hiring_proposal?.warehouse_name,
      [schema_obj.first_accordion.region]: response?.data?.region?.id,
      // need to ffix the ddrill ddown apis ...
      [schema_obj.first_accordion.state]: response?.data?.state?.id,
      [schema_obj.first_accordion.sub_state]: response?.data?.substate?.id,
      [schema_obj.first_accordion.district]: response?.data?.district?.id,
      [schema_obj.first_accordion.area]: response?.data?.area?.id,
      [schema_obj.first_accordion.warehouse_address]:
        response?.data?.hiring_proposal?.warehouse_address,
      [schema_obj.first_accordion.pincode]:
        response?.data?.hiring_proposal?.warehouse_pincode,
      [schema_obj.first_accordion.geo_location_of_warehouse]:
        response?.data?.geo_location_of_warehouse,
      [schema_obj.first_accordion.warehouse_owned_by]:
        response?.data?.warehouse_owned_by,
      [schema_obj.first_accordion.remarks]:
        response?.data?.hiring_proposal?.remarks,
      [schema_obj.first_accordion.hypothecation_of_warehouse]:
        response?.data?.hypothecation_of_warehouse,
      [schema_obj.first_accordion.warehouse_unusable_area]:
        response?.data?.warehouse_unusable_area,
      [schema_obj.first_accordion.warehouse_total_area]:
        response?.data?.warehouse_total_area,
      [schema_obj.first_accordion.user_capacity]: response?.data?.user_capacity,
      [schema_obj.first_accordion.standard_capacity]:
        response?.data?.standard_capacity,
      [schema_obj.first_accordion.storage_available_area]:
        response?.data?.storage_available_area,
      [schema_obj.first_accordion.standard_capacity_available_for_storage]:
        response?.data?.standard_capacity_available_for_storage,
      [schema_obj.first_accordion.rent]: response?.data?.rent,
      [schema_obj.first_accordion.total_rent_per_month]:
        response?.data?.total_rent_per_month,
      [schema_obj.first_accordion.proposal_typpe]:
        response?.data?.lessee?.length > 0 ? "Sub Leased" : "Lease",

      [schema_obj.first_accordion.gg_revenue_ratio]:
        response?.data?.gg_revenue_ratio,

      [schema_obj.first_accordion.lock_and_key_of_warehouse]:
        response?.data?.lock_and_key_of_warehouse,

      [schema_obj.first_accordion.distance_between_walls_and_stock]:
        response?.data?.distance_between_walls_and_stock,

      [schema_obj.first_accordion.no_distance_remarks]:
        response?.data?.no_distance_remarks,

      // second accordion
      [schema_obj.second_accordion.license_type]: response?.data?.license_type,
      [schema_obj.second_accordion.license_number]:
        response?.data?.license_number,
      [schema_obj.second_accordion.license_start_date]:
        response?.data?.license_start_date,
      ...
      [schema_obj.second_accordion.wdra_license_number]:
        response?.data?.wdra_license_number,
      [schema_obj.second_accordion.wdra_license_start_date]:
        response?.data?.wdra_license_start_date,
      [schema_obj.second_accordion.wdra_license_end_date]:
        response?.data?.wdra_license_end_date,
      [schema_obj.second_accordion.fssai_license_number]:
        response?.data?.fssai_license_number,
      [schema_obj.second_accordion.fssai_license_start_date]:
        response?.data?.fssai_license_start_date,
      [schema_obj.second_accordion.fssai_license_end_date]:
        response?.data?.fssai_license_end_date,
      [schema_obj.second_accordion.is_factory_premise]:
        response?.data?.is_factory_premise,
      [schema_obj.second_accordion.factory_premise_remarks]:
        response?.data?.factory_premise_remarks,

      // 4rd accordian .....
      [schema_obj.fourth_accordion.commodity_insurance]:
        response?.data?.commodity_insurance,
      [schema_obj.fourth_accordion.expected_commodity]:
        response?.data?.commodity_id?.id,
      [schema_obj.fourth_accordion.commodity_inward_type]:
        response?.data?.commodity_inward_type,
      [schema_obj.fourth_accordion.commodity_inside_wh]:
        response?.data?.commodity_inside_wh,
      [schema_obj.fourth_accordion.pre_stack_commodity_stack_countable]:
        response?.data?.pre_stack_commodity_stack_countable,
      [schema_obj.fourth_accordion.pre_stack_commodity_level_of_infestation]:
        response?.data?.pre_stack_commodity_level_of_infestation,
      [schema_obj.fourth_accordion.pre_stack_commodity_sample_mandatory]:
        response?.data?.pre_stack_commodity_sample_mandatory,
      [schema_obj.fourth_accordion.funded_by_bank]:
        response?.data?.funded_by_bank === true ? "true" : "false",
      [schema_obj.fourth_accordion.funded_by_bank_remarks]:
        response?.data?.funded_by_bank_remarks,
      [schema_obj.fourth_accordion.gg_access_to_stock_bk]:
        response?.data?.gg_access_to_stock_bk === true ? "true" : "false",

      // 5 th accordian
      [schema_obj.fifth_accordion.weightment_facility]:
        response?.data?.weightment_facility === true ? "true" : "false",
      [schema_obj.fifth_accordion.weighbridge_name]:
        response?.data?.weighbridge_name,
      [schema_obj.fifth_accordion.weighbridge_distance]:
        response?.data?.weighbridge_distance,

      // 6 th one .....
      [schema_obj.gard_accordion.supervisor_day_shift]:
        response?.data?.supervisor_day_shift?.id,
      [schema_obj.gard_accordion.supervisor_night_shift]:
        response?.data?.supervisor_night_shift?.id,
      [schema_obj.gard_accordion.security_guard_day_shift]:
        response?.data?.security_guard_day_shift?.id,
      [schema_obj.gard_accordion.security_guard_night_shift]:
        response?.data?.security_guard_night_shift?.id,
    };
    ...
    Object.keys(obj).forEach(function (key) {
      setValue(key, obj[key], { shouldValidate: false });
    });

    regionOnChange({ value: obj?.region || null });
    stateOnChange({ value: obj?.state || null });
    zoneOnChange({ value: obj?.sub_state || null });
    districtOnChange({ value: obj?.district || null });
    areaOnChange({ value: obj?.area || null });

    // set client table data setClientsDetails :-
    const transformedClientData = response?.data?.client?.map((el) => {
      return {
        client_name: el.client_name,
        id: el.id,
        client_address: el.client_address,
      };
    });

    const transformDataChamberData = response?.data?.chamber?.map((el) => {
      return {
        id: el?.id,
        chamber_number: el?.chamber_number,
        chamber_length: el?.chamber_length,
        chamber_breadth: el?.chamber_breadth,
        roof_height: el?.roof_height,
        stackble_height: el?.stackble_height,
        sq_feet: el?.sq_feet,
        total_area: el?.total_area,
      };
    });

    const tranformedOwnerData = response?.data?.owner?.map((el) => {
      return {
        warehouse_owner_name: el?.warehouse_owner_name,
        warehouse_owner_contact_no: el?.warehouse_owner_contact_no,
        warehouse_owner_address: el?.warehouse_owner_address,
        revenue_sharing_fix_amount: el?.revenue_sharing_fix_amount,
        revenue_sharing_ratio: el?.revenue_sharing_ratio,
        rent_amount: el?.rent_amount,
      };
    });

    setClientsDetails(transformedClientData);
    setChamberDetails(transformDataChamberData);
    setWarehouseOwnersDetails(tranformedOwnerData);
    setReInspectionFetchedData(response?.data);
    // setSelectBoxOptions()
  }
  ...
  const {
    ...
    defaultValues: {
      ...
      [schema_obj.first_accordion.warehouse_owned_by]: "",
      [schema_obj.first_accordion.remarks]: "",
      [schema_obj.first_accordion.hypothecation_of_warehouse]: "false",
      [schema_obj.first_accordion.warehouse_unusable_area]: "",
      [schema_obj.first_accordion.warehouse_total_area]: "",
      ...
      [schema_obj.first_accordion.storage_available_area]: "",
      [schema_obj.first_accordion.standard_capacity_available_for_storage]: "",
      [schema_obj.first_accordion.rent]: "",
      [schema_obj.first_accordion.total_rent_per_month]: "",
      [schema_obj.first_accordion.proposal_typpe]: "Lease",
      [schema_obj.first_accordion.gg_revenue_ratio]: "",
      [schema_obj.first_accordion.lock_and_key_of_warehouse]: "",
      [schema_obj.first_accordion.no_distance_remarks]: "",
      ...
      [schema_obj.second_accordion.license_type]: "",
      [schema_obj.second_accordion.license_type]: "",
      [schema_obj.second_accordion.license_number]: "",
      [schema_obj.second_accordion.license_start_date]: "",
      [schema_obj.second_accordion.license_end_date]: "",
  ...
  //     console.log("response:64756743 ", response);
  ...
  //   try {
  //     const response = await fetchLocationDrillDown(query).unwrap();
  //     console.log("response: for5 trhe sytate ", response);
  ...
  const zoneOnChange = async (val) => {
    console.log("value zone change call--> ", val);
    setValue(schema_obj.first_accordion.sub_state, val?.value, {
      shouldValidate: true,
    });
  ...
  const InspectionDetailFunction = async () => {
    // alert(location?.state?.reInpectionData.id);
    console.log("@@@@@@", location?.state?.reInpectionData);
    try {
      // console.log(location, details, "InspectionDetailFunction");
      const response = await fetchInspectionDetail({
        // id: details?.id,
        id: location?.state?.reInpectionData.warehouse,
      }).unwrap();
                      ...
                      >
                        <Box>
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <ReactSelect
                                  ...
                                  isLoading={reInspectionAllDataLoading}
                                  isDisabled={true}
                                  name={`${schema_obj.first_accordion.warehouse_type}`}
                                  value={
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.warehouse_sub_type}`}
                                  options={
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.warehouse_unit_type}`}
                                  options={
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Textarea
                                  name={`${schema_obj.first_accordion.warehouse_name}`}
                                  {...register(
                                    `${schema_obj.first_accordion.warehouse_name}`
                                  )}
                                  border="1px"
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.region}`}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.state}`}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              <FormControl style={{ w: commonWidth.w }}>
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.sub_state}`}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              <FormControl style={{ w: commonWidth.w }}>
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.district}`}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              <FormControl style={{ w: commonWidth.w }}>
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.area}`}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Textarea
                                  name={`${schema_obj.first_accordion.warehouse_address}`}
                                  {...register(
                                    `${schema_obj.first_accordion.warehouse_address}`
                                  )}
                                  border="1px"
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.pincode}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.pincode}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  type="text"
                                  name={`${schema_obj.first_accordion.geo_location_of_warehouse}`}
                                  {...register(
                                    `${schema_obj.first_accordion.geo_location_of_warehouse}`
                                  )}
                                  border="1px"
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <ReactSelect
                                  name={`${schema_obj.first_accordion.warehouse_owned_by}`}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Box>
                                  <Textarea
                                    name={`${schema_obj.first_accordion.remarks}`}
                                    type="text"
                                    {...register(
                                      `${schema_obj.first_accordion.remarks}`
                                    )}
                              ...
                              >
                                <Box>
                                  <RadioGroup
                                    ...
                                    isDisabled={false}
                                    name={`${schema_obj.first_accordion.hypothecation_of_warehouse}`}
                                    onChange={(e) => {
                                      if (e === "false") {
                                        setValue(
                                          schema_obj.first_accordion
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.warehouse_unusable_area}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.warehouse_unusable_area}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.warehouse_total_area}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.warehouse_total_area}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.user_capacity}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.user_capacity}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.standard_capacity}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.standard_capacity}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.storage_available_area}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.storage_available_area}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.standard_capacity_available_for_storage}`}
                                  type="number"
                                  {...register(
                                    `${schema_obj.first_accordion.standard_capacity_available_for_storage}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.rent}`}
                                  type="text"
                                  {...register(
                                    `${schema_obj.first_accordion.rent}`
                                  )}
                          ...
                          >
                            ...
                            <GridItem colSpan={{ base: 1 }}>
                              ...
                              >
                                <Input
                                  name={`${schema_obj.first_accordion.total_rent_per_month}`}
                                  type="text"
                                  {...register(
                                    `${schema_obj.first_accordion.total_rent_per_month}`
                                  )}
                          ...
                          {selectBoxOptions?.warehouseSubType?.filter(
                            ...
                            >
                              ...
                              <GridItem colSpan={{ base: 1 }}>
                                ...
                                >
                                  <Input
                                    name={`${schema_obj.first_accordion.gg_revenue_ratio}`}
                                    type="text"
                                    {...register(
                                      `${schema_obj.first_accordion.gg_revenue_ratio}`
                                    )}
                        ...
                        >
                          ...
                          <GridItem colSpan={{ base: 1 }}>
                            ...
                            >
                              <ReactSelect
                                name={`${schema_obj.first_accordion.lock_and_key_of_warehouse}`}
                            ...
                            >
                              <Box>
                                <RadioGroup
                                  ...
                                  // isDisabled={getValues("form_edit")}
                                  isDisabled={false}
                                  name={`${schema_obj.first_accordion.distance_between_walls_and_stock}`}
                                  onChange={(e) => {
                                    setValue(
                                      schema_obj.first_accordion
                                        .distance_between_walls_and_stock,
                        ...
                        >
                          ...
                          <GridItem colSpan={{ base: 1 }}>
                            ...
                            >
                              <Box>
                                <Textarea
                                  name={`${schema_obj.first_accordion.no_distance_remarks}`}
                                  type="text"
                                  {...register(
                                    `${schema_obj.first_accordion.no_distance_remarks}`
                                  )}
