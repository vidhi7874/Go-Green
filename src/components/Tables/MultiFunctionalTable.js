...
import { BsCloudDownload, BsPlusCircle } from "react-icons/bs";
      ...
      >
        ...
        {selectedItems.length > 0 ? (
          ...
          >
            ...
            {/* download button icon for the listing data  */}
            <Button
              variant="outline"
              borderColor="border_light.100"
              p="0px 10px"
                ...
                <Tr key={`'table_row_${row.id}`}>
                  <Td>
                    <Checkbox
                      ...
                      onChange={() =>
                        SelectionFunction(
                          row?.original?.id || row?.original?.cor__id?.id
                        )
                      }
                    ></Checkbox>
                  </Td>
